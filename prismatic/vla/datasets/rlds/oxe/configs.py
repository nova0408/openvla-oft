...
class StateEncoding(IntEnum):
    ...
    JOINT_28 = 5            # Custom 28-dimensional joint state
    # fmt: on
...
class ActionEncoding(IntEnum):
    ...
    JOINT_POS_28 = 5        # Custom 28-dimensional absolute joint target
    # fmt: on
...
OXE_DATASET_CONFIGS = {
    "le_robot_rlds": {
        "image_obs_keys": {
            ...
            "right_wrist": "wrist_image_2",
        },
        "depth_obs_keys": {"primary": None, "left_wrist": None, "right_wrist": None},
        "state_obs_keys": ["state"],
        "state_encoding": StateEncoding.JOINT_28,
        "action_encoding": ActionEncoding.JOINT_POS_28,
    },
